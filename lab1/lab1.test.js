...
// should output 196
console.log(lab1.questionThree("qwQWrtRTyYpP"));
// should output 0
console.log(lab1.questionThree("AEIOUaeiouYY"));
// should output 10
console.log(lab1.questionThree("The brown fox jumped over the lazy dog."));
// should output 10
